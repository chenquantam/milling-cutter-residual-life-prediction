...
STORAGE_PATH = "D:/1.xls"
FILE_PATH = 'C:/Users/liam/Desktop/Cal值后测试LOG File/FOC22196KSW_0517-105417_PASS/'
...
if __name__ == '__main__':
    ...
    row1 = ['PCBA', 'Test Date', 'Test Time', 'TestName', 'CH', 'Demod', 'Rate', 'Chain',
            'Data', 'Unit', 'LimitLo', 'LimitHi', 'P/F', 'ReTest', 'UsedTime', 'Remark']
    # 初始化行的默认值
    x1 = 1
    x2 = 1
    x4 = 1
    ...
    for excel_file in [_file for _file in os.listdir(FILE_PATH) if _file.endswith('.csv')]:
        ...
        with open(FILE_PATH + excel_file, 'r', encoding='utf-8') as csvfile:  # 打開文件
            ...
            for i in read:
                # 筛选
                if len(i) > 2 and i[0] == '5G VHT160 RX SEN RSSI' and i[1].strip() == '114' and i[
                    2].strip() == 'VHT160' and i[3].strip() == 'MCS9' and i[4].strip() in ['1', '2', '4', '8']:
